...
[Script]
建行数据 = type=http-request,pattern=^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|autoLogin),requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/axtyet/animator/main/repository/Fokit/scripts/jhsh_checkIn.js

建行生活 = type=cron,cronexp=17 7 * * *,timeout=60,script-path=https://raw.githubusercontent.com/axtyet/animator/main/repository/Fokit/scripts/jhsh_checkIn.js,script-update-interval=0
...
[Script]
http-request ^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|autoLogin) tag=建行数据, script-path=https://raw.githubusercontent.com/axtyet/animator/main/repository/Fokit/scripts/jhsh_checkIn.js,requires-body=1

cron "17 7 * * *" script-path=https://raw.githubusercontent.com/axtyet/animator/main/repository/Fokit/scripts/jhsh_checkIn.js,tag = 建行生活,enable=true
...
[rewrite_local]
^https:\/\/yunbusiness\.ccb\.com\/(clp_coupon|clp_service)\/txCtrl\?txcode=(A3341A038|autoLogin) url script-request-body https://raw.githubusercontent.com/axtyet/animator/main/repository/Fokit/scripts/jhsh_checkIn.js

[task_local]
17 7 * * * https://raw.githubusercontent.com/axtyet/animator/main/repository/Fokit/scripts/jhsh_checkIn.js, tag=建行生活, enabled=true
...
script-providers:
  建行生活:
    url: https://raw.githubusercontent.com/axtyet/animator/main/repository/Fokit/scripts/jhsh_checkIn.js
    interval: 86400
